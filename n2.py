...
node2 = SimpleXMLRPCServer(('localhost', 10002), logRequests = True, allow_none = True)
...
#     x = random.randint(0, 1)
    ...
    def success(self, list):
        ...
        if self.p>10 and self.ye == 5:
                ...
                now = datetime.now()
                list1.append("I waited too long to send the commit, thus I'm asking TC for transaction details."+now.strftime("%d-%m-%Y %H:%M:%S"))
                print("----------Begin----->transaction information----------")
                now = datetime.now()
                list1.append("----------Begin----->transaction information----------"+now.strftime("%d-%m-%Y %H:%M:%S"))
                for i in list:
                    print("\n")
                    print(i)
                ...
                now = datetime.now()
                list1.append("----------End----->transaction information----------"+now.strftime("%d-%m-%Y %H:%M:%S"))
